...
* **Latest facility-level data**: Our latest facility-level COVID-19 data is maintained in this repository (`adult_facility_covid_counts.csv`). 
* **Latest state-aggregated data**: Our latest COVID-19 data aggregated to the state level is maintained in this repository (`state_aggregate_counts.csv`). 
* **Historical data**: Our historical facility-level data is maintained in [our `historical-data` repository](https://github.com/uclalawcovid19behindbars/historical-data/tree/main/data). We are in the process of cleaning this data and will be adding additional states as this data becomes available. 
